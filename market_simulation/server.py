...
class Server:
    ...
    def __init__(self, config_file: str):
        with open(config_file) as file:
            ...
            self.processes_mq = self.get_ipc_queue(
    ...
    def stop(self) -> int:
        ...
        print(
            f"\n{Back.RED}{Fore.WHITE}***** Begin server stop process *****{Style.RESET_ALL}"
        )
...
if __name__ == "__main__":
    ...
    print(f"{Fore.LIGHTMAGENTA_EX}Stopping server, bye :){Style.RESET_ALL}")
    sys.exit(0)
